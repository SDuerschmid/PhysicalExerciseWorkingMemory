...
errorbar( [1.2 1.8], mean( B ),std( B )./sqrt( 21 ),'color',[.3 .3 .3],'CapSize',0,'LineWidth',3 )
myaxis('condition','performance' )
...
for n = 1:3;
    ...
    text( x( n,1 ),1.2,[signum{ n }],'FontName','times','FontSize',30)
end
myaxis('condition','performance' )
